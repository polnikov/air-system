class CONSTANTS:
    ...
    class INIT_DATA:
        ...
        LABELS = (
            (
                ...
                ('Коэффициент эквивалентной шероховатости канала, Kэ', 'мм'),
        ...
        KLAPAN_INPUT_LABEL_1 = 'Расход воздуха через клапан'
    ...
    class BUTTONS:
        ...
        DELETE_BUTTON_TOOLTIP = 'Удалить строку из таблицы'
        ADD_BUTTON_TOOLTIP = 'Добавить строку в конец таблицы'
